      ...
      module Helpers
        module Constants
          ...
          DEPTH_RARITY_WEIGHTS = {
            surface: { pattern: 30, skill: 20, knowledge: 20, memory_fragment: 15,
                       association: 10, procedure: 3,  belief: 1,  schema: 1  },
            shallow: { pattern: 20, skill: 20, knowledge: 20, memory_fragment: 15,
                       association: 10, procedure: 8,  belief: 5,  schema: 2  },
            mid:     { pattern: 15, skill: 15, knowledge: 15, memory_fragment: 15,
                       association: 15, procedure: 10, belief: 8,  schema: 7  },
            deep:    { pattern: 5,  skill: 10, knowledge: 15, memory_fragment: 20,
                       association: 15, procedure: 10, belief: 15, schema: 10 },
            bedrock: { pattern: 3,  skill: 5,  knowledge: 10, memory_fragment: 20,
                       association: 10, procedure: 10, belief: 22, schema: 20 }
          }.freeze
